...
$ `wget -q '--no-check-certificate' https://github.com/itorres2020/Speedy-OEA-MX-autoinstall/raw/refs/heads/main/speedy_OEA_autoinstall.sh; bash speedy_OEA_autoinstall.sh; rm -r speedy_OEA_autoinstall.sh`
